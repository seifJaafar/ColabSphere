...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    setRotations(testimonials.map(() => Math.floor(Math.random() * 21) - 10)); // Generates random rotations once on the client
  }, [testimonials]);
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  initial={{
                    ...
                    scale: 0.9,
                    z: -100,
                    rotate: rotations[index] || 0, // Uses precomputed rotation values
                  }}
                  animate={{
